...
public class Setting extends Pane  {
    ...
    Setting(GridPane grid, Profile prof) {
   ...
   /**
    */
    private void sendToProfile(GridPane grid, Profile prof) {
		grid.getChildren().add(prof);
	}
